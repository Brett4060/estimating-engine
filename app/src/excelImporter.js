...
function parseGablesType(ws, offset, pricing) {
  ...
  return {
    ...
    // Beam supports
    beamSupportQty: cellNum(ws, 27, dc),
    beamSupportTubeType: matchSelect(cellStr(ws, 30, tc), pricing.TUBING),
    // Track
    ...
    // Angles
    topAngleInstalled: cellBool(ws, 39, tc),
    topAngleShipped: cellBool(ws, 40, tc),
    topAngleType: matchSelect(cellStr(ws, 41, tc), pricing.ANGLES),
    bottomAngleInstalled: cellBool(ws, 42, tc),
    bottomAngleShipped: cellBool(ws, 43, tc),
    bottomAngleType: matchSelect(cellStr(ws, 44, tc), pricing.ANGLES),
    // Sheathing
    ...
    // Extras
    interiorWallCount: cellNum(ws, 53, dc),
...
function parseGableRoofType(ws, offset, pricing) {
  ...
  return {
    ...
    endInsideTubeType: matchSelect(cellStr(ws, 34, tc), pricing.TUBING),
    endOutsideTubeType: matchSelect(cellStr(ws, 37, tc), pricing.TUBING),
    // Per-connection bent metal toggles + types + qtys
    insideGable: cellBool(ws, 39, tc),
    insideGableConnQty: cellNum(ws, 39, dc) || 4,
    insideGableConnType: matchSelect(cellStr(ws, 41, tc), pricing.BENT),
    outsideGable: cellBool(ws, 42, tc),
    outsideGableConnQty: cellNum(ws, 42, dc) || 4,
    outsideGableConnType: matchSelect(cellStr(ws, 44, tc), pricing.BENT),
    insideRidge: cellBool(ws, 46, tc),
    insideRidgeConnQty: cellNum(ws, 46, dc) || 1,
    insideRidgeConnType: matchSelect(cellStr(ws, 48, tc), pricing.BENT),
    outsideRidge: cellBool(ws, 49, tc),
    outsideRidgeConnQty: cellNum(ws, 49, dc) || 1,
    outsideRidgeConnType: matchSelect(cellStr(ws, 51, tc), pricing.BENT),
    insidePurlin: cellBool(ws, 53, tc),
    insidePurlinConnQty: cellNum(ws, 53, dc) || 2,
    insidePurlinConnType: matchSelect(cellStr(ws, 55, tc), pricing.BENT),
    outsidePurlin: cellBool(ws, 56, tc),
    outsidePurlinConnType: matchSelect(cellStr(ws, 58, tc), pricing.BENT),
    // Wall connections
    insideWall: cellBool(ws, 60, tc),
    insideWallConnType: matchSelect(cellStr(ws, 62, tc), pricing.BENT),
    outsideWall: cellBool(ws, 63, tc),
    outsideWallConnType: matchSelect(cellStr(ws, 65, tc), pricing.BENT),
    insideWallOH: cellBool(ws, 67, tc),
    insideWallOHConnQty: cellNum(ws, 67, dc) || 1,
    insideWallOHConnType: matchSelect(cellStr(ws, 69, tc), pricing.BENT),
    // Misc
    simpsonTieDown: cellBool(ws, 70, tc),
    gutterBoard: cellBool(ws, 72, tc),
    gutterConnQty: cellNum(ws, 72, dc) || 2,
    gutterConnType: matchSelect(cellStr(ws, 74, tc), pricing.BENT),
    intSheathing: cellBool(ws, 76, tc),
    intSheathingType: matchSelect(cellStr(ws, 77, tc), pricing.SHEATHING),
    interiorWallCount: cellNum(ws, 81, dc),
...
function parseHipRoofType(ws, offset, pricing) {
  ...
  return {
    ...
    // Per-connection bent metal types
    insideRidge: cellBool(ws, 40, tc),
    insideRidgeConnType: matchSelect(cellStr(ws, 42, tc), pricing.BENT),
    outsideRidge: cellBool(ws, 43, tc),
    outsideRidgeConnType: matchSelect(cellStr(ws, 45, tc), pricing.BENT),
    insidePurlinPar: cellBool(ws, 47, tc),
    insidePurlinParConnQty: cellNum(ws, 47, dc) || 1,
    insidePurlinParConnType: matchSelect(cellStr(ws, 48, tc), pricing.BENT),
    insidePurlinPerp: cellBool(ws, 49, tc),
    insidePurlinPerpConnQty: cellNum(ws, 49, dc) || 1,
    insidePurlinPerpConnType: matchSelect(cellStr(ws, 50, tc), pricing.BENT),
    outsidePurlinPar: cellBool(ws, 52, tc),
    outsidePurlinParConnType: matchSelect(cellStr(ws, 53, tc), pricing.BENT),
    outsidePurlinPerp: cellBool(ws, 54, tc),
    outsidePurlinPerpConnType: matchSelect(cellStr(ws, 55, tc), pricing.BENT),
    insideHip: cellBool(ws, 58, tc),
    insideHipConnType: matchSelect(cellStr(ws, 60, tc), pricing.BENT),
    outsideHip: cellBool(ws, 61, tc),
    outsideHipConnType: matchSelect(cellStr(ws, 63, tc), pricing.BENT),
    // Wall connections
    insideWallPar: cellBool(ws, 65, tc),
    insideWallParConnType: matchSelect(cellStr(ws, 67, tc), pricing.BENT),
    insideWallPerp: cellBool(ws, 68, tc),
    insideWallPerpConnType: matchSelect(cellStr(ws, 70, tc), pricing.BENT),
    outsideWallPar: cellBool(ws, 71, tc),
    outsideWallParConnType: matchSelect(cellStr(ws, 73, tc), pricing.BENT),
    outsideWallPerp: cellBool(ws, 74, tc),
    outsideWallPerpConnType: matchSelect(cellStr(ws, 76, tc), pricing.BENT),
    // Wall w/ overhang
    insideWallPar2: cellBool(ws, 78, tc),
    insideWallPar2ConnType: matchSelect(cellStr(ws, 80, tc), pricing.BENT),
    insideWallPerp2: cellBool(ws, 81, tc),
    insideWallPerp2ConnType: matchSelect(cellStr(ws, 83, tc), pricing.BENT),
    // Misc
    simpsonTieDown: cellBool(ws, 84, tc),
    gutterBoardPar: cellBool(ws, 86, tc),
    gutterBoardParConnType: matchSelect(cellStr(ws, 88, tc), pricing.BENT),
    gutterBoardPerp: cellBool(ws, 89, tc),
    gutterBoardPerpConnType: matchSelect(cellStr(ws, 91, tc), pricing.BENT),
    intSheathing: cellBool(ws, 93, tc),
    intSheathingType: matchSelect(cellStr(ws, 94, tc), pricing.SHEATHING),
    interiorWallCount: cellNum(ws, 99, dc),
...
function parseSingleSlopeType(ws, offset, pricing) {
  ...
  return {
    ...
    faciaLen: cellNum(ws, 8, dc), // defaults to ridge length
    ...
    insideGableConnQty: cellNum(ws, 40, dc) || 2,
    insideGableConnType: matchSelect(cellStr(ws, 42, tc), pricing.BENT),
    outsideGable: cellBool(ws, 43, tc),
    outsideGableConnType: matchSelect(cellStr(ws, 45, tc), pricing.BENT),
    // Ridge OH
    insideRidgeOH: cellBool(ws, 47, tc),
    insideRidgeOHConnType: matchSelect(cellStr(ws, 49, tc), pricing.BENT),
    // Purlin
    insidePurlin: cellBool(ws, 63, tc),
    insidePurlinConnQty: cellNum(ws, 63, dc) || 2,
    insidePurlinConnType: matchSelect(cellStr(ws, 65, tc), pricing.BENT),
    outsidePurlin: cellBool(ws, 66, tc),
    outsidePurlinConnType: matchSelect(cellStr(ws, 68, tc), pricing.BENT),
    // Wall
    insideWall: cellBool(ws, 70, tc),
    wallConnQty: cellNum(ws, 70, dc) || 2,
    insideWallConnType: matchSelect(cellStr(ws, 72, tc), pricing.BENT),
    outsideWall: cellBool(ws, 73, tc),
    outsideWallConnType: matchSelect(cellStr(ws, 75, tc), pricing.BENT),
    // Wall OH
    insideWallOH: cellBool(ws, 78, tc),
    insideWallOHConnType: matchSelect(cellStr(ws, 80, tc), pricing.BENT),
    // Misc
    simpsonTieDown: cellBool(ws, 57, tc),
    faciaBoard: cellBool(ws, 59, tc),
    faciaConnQty: cellNum(ws, 59, dc) || 1,
    faciaConnType: matchSelect(cellStr(ws, 61, tc), pricing.BENT),
    gutterBoard: cellBool(ws, 82, tc),
    gutterConnQty: cellNum(ws, 82, dc) || 2,
    gutterConnType: matchSelect(cellStr(ws, 84, tc), pricing.BENT),
    intSheathing: cellBool(ws, 86, tc),
    intSheathingType: matchSelect(cellStr(ws, 87, tc), pricing.SHEATHING),
    interiorWallCount: cellNum(ws, 92, dc),
